...
if ($_POST['select0'] != 0) {
    ...
    $query0 = "select possale1 from possaleinfo where id = $select0";
    $query1 = "select possale2 from possaleinfo where id = $select0";
    $query2 = "select possale3 from possaleinfo where id = $select0";
