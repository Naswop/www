...
if ($_POST['select3'] != 0) {
    ...
    $query0 = "select possale1 from possaleinfo where id = $select3";
    $query1 = "select possale2 from possaleinfo where id = $select3";
    $query2 = "select possale3 from possaleinfo where id = $select3";
