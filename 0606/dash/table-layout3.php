                        ...
                        <ul class="metismenu" id="menu">
                            <li class="active">
                                <a href="javascript:void(0)" aria-expanded="true"><i class="fa fa-table"></i>
                                    <span>积分活动</span></a>
                                <ul class="collapse">
                                    <li ><a href="table-layout.php">店铺活动信息</a></li>
                                    <liclass="active"><a href="table-layout3.php">积分兑礼信息</a></liclass=>
                                </ul>
                            </li>
                        </ul>
                    </nav>
            ...
            <div class="main-content-inner">
                <div class="row">
                    <div class="col-12 mt-5">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="header-title">积分兑礼设置</h4>
                                <div><button class='btn btn-success btn-md mb-3' id='add' style='padding: 1px 16px;margin-left: 5px'>新增</button>
                                <button class='btn btn-info btn-md mb-3' id='download' style='padding: 1px 16px;margin-left: 5px'><a href="assets/积分兑礼模板.xlsx" download="积分兑礼模板.xlsx" style="color: #fff;">下载导入模板</a></button>
                                ...
                                <div class="data-tables">
                                    <table  id="dataTable"class="text-center">
                                        ...
                                        <tbody>
                                            ...
                                            $sql = 'select * from giftinfo order by id asc';
                                            // 结果集
                                    ...
                                    <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <span><h4>编号:     </h4></span> <h4 class="modal-title ss" id="myModalLabel" style="display: inline-block" data-index="0">Modal
                                                        title</h4>
                                                ...
                                                <div class="modal-body">
                                                    <form class="form-horizontal" id="form">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-10">
                                                                <input type="text" class="form-control ss" name="giftname" placeholder="礼品名" data-index="1">
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label class="col-sm-4 control-label">积分</label>
                                                            <div class="col-sm-10">
                                                                <input type="text" class="form-control ss" name="giftpoint" placeholder="积分" data-index="2">
                                                            </div>
                                                        </div>
                                                    </form>
                                                </div>
                                    ...
                                    <div class="modal fade" id="myModal2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                <span><h4>编号:     </h4></span> <h4 class="modal-title ss" id="myModalLabel" style="display: inline-block" data-index="0">新增兑礼信息</h4>
                                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
            ...
            success: function(res) {
                ...
                for (var i = 0; i < data.length; i++) {
                    str = "<tr><td>" + data[i].id + "</td><td>" +
                        data[i].giftname + "</td><td>" +
                        data[i].giftpoint + "</td><td>" +
"</td><td><button class='btn btn-primary btn-xs' id='change' data-toggle='modal' data-target='myModal'>修改</button><button class='btn btn-danger btn-xs' id='del' style='margin-left: 5px'>删除</button></td></tr>";
                    $("#tablehtml").html(str)
                }
            }
        })
    ...
    $(document).on("click", "#sign", function() {
        ...
        $.ajax({
            url: "active/layout2/edit.php?id=" + t,
            type: "POST",
            data: data1,
            success: function(res) {
